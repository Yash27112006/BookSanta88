...
import {BookSearch} from require('react-native-google-books');
...
export default class BookRequestScreen extends Component{
  ...
  addRequest = async(bookName,reasonToRequest)=>{
    ...
    var books = await BookSearch.searchBook(bookName, 'AIzaSyAXkH3EF5d41de2ILcPhhP3zovwsy7vkY0');
    ...
    if(this.state.isBookRequestActive === true){
       return(
         <View style = {{flex: 1, justifyContent: "center"}}>
           <View style = {{borderColor: "orange", justifyContent: "center", borderWidth: 3, alignItems: "center", padding: 10, margin: 10}}>
              <Text>Book Name</Text>
           ...
           <TouchableOpacity style = {{alignSelf: "center", alignItems: "center",width: 300, height: 30, marginTop: 30}}
           onPress = {() =>{
